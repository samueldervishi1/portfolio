          ...
          >
            ...
            <div className="text-slate-400 space-y-4 leading-relaxed">
              <p>
                ...
                interest in backend development started back in university when I first worked with
                Java and realized the power of strictly typed, robust systems.
              </p>
              <p>
                Fast-forward to today, I've had the privilege of building software for diverse
                clients. My main focus these days is building accessible, inclusive products and
                digital experiences for a variety of clients.
              </p>
              <p>
                When I'm not coding, you can find me on the basketball court, watching the latest
                sci-fi movies, or solving logic puzzles to keep my mind sharp.
              </p>
            </div>
          </motion.div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {languages.map((s) => (
                    <SkillTag key={s.name} name={s.name} icon={s.icon} />
                  ))}
                </div>
              </div>
