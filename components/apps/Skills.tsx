  ...
  return (
    <div className="h-full p-4 bg-[#ECE9D8] font-sans text-xs">
      ...
      <div className="flex gap-1 mb-2 border-b border-white">
         <div className="bg-white border-t border-l border-r border-[#7F9DB9] px-3 py-1 rounded-t relative -bottom-[1px] z-10">General</div>
         <div className="bg-[#ECE9D8] border border-[#7F9DB9] px-3 py-1 rounded-t text-gray-600">Computer Name</div>
         <div className="bg-[#ECE9D8] border border-[#7F9DB9] px-3 py-1 rounded-t text-gray-600">Hardware</div>
         <div className="bg-[#ECE9D8] border border-[#7F9DB9] px-3 py-1 rounded-t text-gray-600">Advanced</div>
      </div>
      ...
      <div className="bg-white border border-[#7F9DB9] p-4 h-[calc(100%-40px)] flex gap-4">
         <div className="flex flex-col items-center gap-4 w-1/3 pt-4">
            <div className="w-32 h-24">
                <img src="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=300&q=80" className="w-full h-full object-cover border border-gray-400 shadow-inner" alt="System" />
            </div>
         </div>
