  ...
  return (
    <div className="h-full flex bg-white">
      ...
      <div className="w-64 bg-gray-50 border-r border-gray-200 overflow-y-auto hidden md:flex flex-col py-6 px-5">
        ...
        {/* Skills Section */}
        <div className="mb-8">
          <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-4">Technical Skills</h3>
        ...
        {/* Languages Section */}
        <div>
          <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-4">Languages</h3>
          <div className="space-y-2">
            {skillsByCategory['Language']?.map(lang => (
              <div key={lang.name} className="flex items-center justify-between text-sm">
                <span className="text-gray-700">{lang.name}</span>
                <span className="text-xs text-gray-500">{lang.level === 100 ? 'Native' : 'Fluent'}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                Hi! I'm Samuel Dervishi, a <strong className="text-gray-900">Backend Developer</strong> based in Albania.
                I specialize in building scalable solutions using <strong className="text-gray-900">Java, Spring Boot, Oracle databases</strong>,
                and modern backend architectures.
              </p>
              <p>
                I'm passionate about creating robust, efficient systems that solve real-world problems.
                My expertise includes backend development, database optimization, and building scalable microservices architectures.
              </p>
              <p>
                When I'm not coding, you'll find me playing basketball, watching movies,
                or working on side projects that push the boundaries of what's possible with technology.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4 pt-4">
            <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wider">Primary Tech Stack</h2>
          ...
          {/* Interests Section */}
          <div className="space-y-4 pt-4">
            <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wider">Interests & Hobbies</h2>
            <div className="flex flex-wrap gap-2">
              {['Basketball', 'Movies', 'Side Projects', 'Open Source', 'Backend Architecture', 'Problem Solving'].map(interest => (
                <span
                  key={interest}
