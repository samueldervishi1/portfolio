...
const WindowFrame: React.FC<WindowFrameProps> = ({
  ...
  const [initialResizeState, setInitialResizeState] = useState({ w: 0, h: 0, x: 0, y: 0, mouseX: 0, mouseY: 0 });
  ...
  }, [isDragging, isResizing, dragOffset, win.id, initialResizeState, resizeDirection, onMove, onResize]);
  ...
  return (
    ...
    >
      ...
      {!win.isMaximized && (
        <>
          <div className="resize-handle absolute bottom-0 right-0 w-4 h-4 cursor-se-resize z-50" 
               onMouseDown={(e) => handleResizeStart(e, 'se')} />
          <div className="resize-handle absolute bottom-0 left-0 w-1 h-full cursor-w-resize z-40" />
          <div className="resize-handle absolute top-0 right-0 w-1 h-full cursor-e-resize z-40" 
               onMouseDown={(e) => handleResizeStart(e, 'e')} />
          <div className="resize-handle absolute bottom-0 left-0 w-full h-1 cursor-s-resize z-40" 
