        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-4 pt-4">
              <a href={GITHUB_URL} target="_blank" rel="noopener noreferrer" className="p-3 bg-surface rounded-lg text-slate-400 hover:text-accent hover:-translate-y-1 transition-all">
                <Github size={24} />
              </a>
              <a href={LINKEDIN_URL} target="_blank" rel="noopener noreferrer" className="p-3 bg-surface rounded-lg text-slate-400 hover:text-accent hover:-translate-y-1 transition-all">
                <Linkedin size={24} />
              </a>
            </div>
          </div>
          ...
          {/* Form */}
          <form onSubmit={handleSubmit} className="space-y-4 bg-surface p-6 rounded-xl border border-slate-800">
